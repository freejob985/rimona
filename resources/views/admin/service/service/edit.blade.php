                ...
                <div class="row">
                    <div class="col-lg-6 offset-lg-3">
                        <form class="mb-3 dm-uploader drag-and-drop-zone" enctype="multipart/form-data"
                            action="{{route('admin.service.uploadUpdate', $service->id)}}" method="POST">
                            @csrf
                        ...
                        <form id="ajaxForm" class="" action="{{route('admin.service.update')}}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category">
                                    ...
                                    <option value="{{$ascat->id}}"
                                        {{$ascat->id == $service->scategory_id ? 'selected' : ''}}>{{$ascat->name}}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="summary" placeholder="Enter summary"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="meta_keywords" value="{{$service->meta_keywords}}"
                        ...
                        <form method="POST" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    ...
                                    <div id="Logo_ar"> </div>
                                    <a class="btn btn-info  btn-block" style="color: white;" id="Logo">addition</a>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    ...
                                    <div id="Products_ar"> </div>
                                    <a class="btn btn-success  btn-block" style="color: white;"
                                        id="Products">addition</a>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    ...
                                    <div id="Projects_ar"> </div>
                                    <a class="btn btn-warning  btn-block" style="color: white;"
                                        id="Projects">addition</a>
        ...
        $("input[name='details_page_status']").on('change', function() {
            ...
            $("#Logo").click(function () {
                ...
                $("#Logo_ar").append("<div class=\"form-row\">\n" +
                    ...
                    "\n" +
                    "  <div class=\"form-group\">\n" +
                    "    <textarea  placeholder=\"Please enter data  paragraph\" name=\"paragraph\"   style=\"resize: none;font-size: 18px;font-weight: 600;color: white !important;background: #0e1726;\"class=\"form-control\" rows=\"5\" id=\"comment\"></textarea>\n" +
                    "    @if ($errors->has('explanation'))\n" +
                    "    <span class=\"helper-text\" data-error=\"wrong\" data-success=\"right\">{{ $errors->first('paragraph') }}</span>\n" +
                    "    @endif\n" +
                    "  </div>\n" +
                    "\n" +
