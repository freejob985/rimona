                     ...
                     <table class="table table-striped mt-3">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>
                                 <?php
                                 foreach (DB::table('services')->where('id', $service->service)->get() as $item) {
                              ...
                              <td>
                                 <a class="btn btn-secondary btn-sm"
                                    href="{{route('admin.sections.edit', $service->id) . '?language=' . request()->input('language')}}">
                                    <span class="btn-label">
                                       <i class="fas fa-edit"></i>
                                    </span>
                                    Edit
                                 </a>
                                 <form class="deleteform d-inline-block" action="{{route('admin.sections.delete')}}"
                                    method="post">
                                    @csrf
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form class="mb-3 dm-uploader drag-and-drop-zone modal-form" enctype="multipart/form-data"
               action="{{route('admin.service.upload')}}" method="POST">
