          ...
          <div class="card-body pt-5 pb-5">
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                  ...
                  <div class="form-group">
                    <textarea  placeholder="Please enter data  Title" name="explanation"   style="resize: none;font-size: 18px;font-weight: 600;color: white !important;background: #0e1726;"class="form-control" rows="5" id="comment">{{$feature->explanation}}</textarea>
