                       ...
                       <div class="single-blog">
                          ...
                          <div class="col-md-8 col-xs-12">
                            ...
                            @endphp
                             ...
                             <h4 class="blog-title"><a href="{{route('front.blogdetails', [$blog->slug, $blog->id])}}">{{convertUtf8(strlen($blog->title)) > 240 ? convertUtf8(substr($blog->title, 0, 240)) . '...' : convertUtf8($blog->title)}}</a></h4>
