            ...
            <div class="{{$input->type == 4 || $input->type == 3 ? 'col-lg-12' : 'col-lg-6'}}">
              <div class="form-element mb-4">
                ...
                <div class="custom-control custom-checkbox custom-control-inline">
                  <input type="checkbox" id="customCheckboxInline{{$option->id}}" name="{{$input->name}}[]"
                    class="custom-control-input" value="{{convertUtf8($option->name)}}"
...
<div class="container"><img style="padding-bottom:55px;opacity:0.6;width:100%;margin:auto;"
    src="http://bus.digi-gate.tech/assets/front/img/page20.jpg" /></div>
@endsection