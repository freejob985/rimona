...
@if (count(DB::table('sections')->orderBy('id','desc')->where('service',$service->id)->where('Type',"Logo")->get())>0)

<section class="finlance_service service_v1 gray_bg pt-120 bg-white">
    <div class="container">
        <h3 style="text-align: initial;">اللوجهات</h3>
        <hr>
            ...
            <div class="grid_item">
                <div class="grid_inner_item">
                    ...
                    <div class="finlance_icon" style="margin-bottom: 20px;">
                        <img src="{{asset('assets/front/img/Logo/' . $servicess->File)}}" alt="File" />
                    </div>
